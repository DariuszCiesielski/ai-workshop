...
description: Wykrywanie i obrona przed atakami prompt injection na modele AI (LLM, voiceboty). Triggery — "wykryj prompt injection", "audytuj bezpieczeństwo bota", "sprawdź czy bot jest podatny na manipulację", "jailbreak". Adapted from mukul975/Anthropic-Cybersecurity-Skills (Apache-2.0).
