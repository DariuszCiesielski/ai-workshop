---
name: create-rule
description: Tworzenie reguł Cursor (.cursor/rules/*.mdc) dla trwałych wytycznych AI. Używaj gdy użytkownik chce dodać regułę, konwencje kodowania, wzorce per-plik, RULE.md lub pyta o .cursor/rules/ czy AGENTS.md.
---
