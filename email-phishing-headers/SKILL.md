---
name: email-phishing-headers
description: Analiza nagłówków email pod kątem phishingu — SPF/DKIM/DMARC validation, sender authenticity, spoofing detection. Triggery — "przeanalizuj nagłówki email", "czy to phishing", "sprawdź pocztę pod kątem oszustwa", "analiza phishing". Adapted from mukul975/Anthropic-Cybersecurity-Skills (Apache-2.0).
