---
name: threat-modeling-dragon
description: Threat modeling z OWASP Threat Dragon — generowanie modeli zagrożeń, STRIDE analysis, identyfikacja powierzchni ataku, mitigation strategies. Triggery — "zrób threat model", "STRIDE analysis", "architektura bezpieczeństwa", "przed deploy", "modeluj zagrożenia". Adapted from mukul975/Anthropic-Cybersecurity-Skills (Apache-2.0).
